"""
@Ahmad RAfi Faiqiri: u1503285@utah.edu
...
def SVM_SGD(df,epoch,w_initial,Gamma_0,C):
...
# file1 = open("results2b.txt","w")#write mode
...
for Gamma_0 in Gamma_0_list:
    # for a in a_list:
        for C in C_list:
            ...
            # a = 100
            # C = 100/873
            w = SVM_SGD(df_train,epoch,w_initial,Gamma_0,C)
